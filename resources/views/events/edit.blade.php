                                ...
                                <div class="tab-content">
                                    <div id="tab-1" class="tab-pane active">
                                        <div class="panel-body">
                                            <form method="POST" enctype="multipart/form-data" class="form-horizontal" action={{route("events.update", $event->id)}}>
                                                @csrf
                                                @method('PUT')

                                                <div class="form-group"><label class="col-sm-2 control-label">Main Title:</label><div class="col-sm-10">
                                                        <input type="text" class="form-control" name="main_title" value="{{ $event->main_title }}" placeholder="Main Title"></div>
                                                ...
                                                <div class="form-group"><label class="col-sm-2 control-label">Second Title:</label><div class="col-sm-10">
                                                        <input type="text" class="form-control" name="second_title" value="{{ $event->second_title }}" placeholder="Second Title"></div>
                                                    @component('components.error', ['errorName'=>'second_title'])@endcomponent
                                                </div>
                                                <div class="form-group"><label class="col-sm-2 control-label" for="date_added">Start Date:</label><div class="col-sm-4 input-group date">
                                                ...
                                                <div class="form-group"><label class="col-sm-2 control-label" for="date_added">Start Time:</label>
                                                    <div class="col-sm-4 input-group clockpicker" data-autoclose="true">
                                                        <input name="start_time" type="text" class="form-control" value="{{$event->start_time}}" >
                                                ...
                                                <div class="form-group"><label class="col-sm-2 control-label" for="date_modified">End Date:</label><div class="col-sm-4 input-group date">
                                                        <span class="input-group-addon"><i class="fa fa-calendar"></i></span>
                                                        <input name="end_date" type="text" class="form-control date" value="{{$event->end_date}}">
                                                    </div>
                                                ...
                                                <div class="form-group"><label class="col-sm-2 control-label" for="date_added">End Time:</label>
                                                    <div class="col-sm-4 input-group clockpicker" data-autoclose="true">
                                                        <input name="end_time" type="text" class="form-control" value="{{$event->end_time}}" >
                                                        <span class="input-group-addon">
                                                            <span class="fa fa-clock-o"></span>
                                                        </span>
                                                    </div>
                                                ...
                                                <div class="form-group"><label class="col-sm-2 control-label">Visitors<br/><small class="text-navy">List</small></label>
                                                    <select class="select2_demo_2 col-sm-9" name="visitors[]" multiple="multiple">
                                                        @foreach($visitors as $visitor)
                                                            @if(in_array($visitors[0]->id, $eventVisitors))
                                                                <option value="{{$visitor->id}}" selected>{{$visitor->user->fname}}</option>
                                                            @else
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <input type="text"   name="address"  id="address-input"class="form-control map-input" value="{{$event->locations->address}}">
                                                    <input type="hidden" name="latitude" id="address-latitude" value="{{$event->locations->latitude}}" />
                                                    <input type="hidden" name="longitude" id="address-longitude" value="{{$event->locations->longitude}}" />
                                                </div>
    ...
    <script>
        ...
        Dropzone.options.documentDropzone = {
            ...
            init: function () {
                ...
                console.log({!! json_encode($event->images) !!})
                ...
                for (let i in images) {
                    ...
                    file.name = "Image";
                    file.size = "2000000";
                    file.path = "{{env("APP_URL")}}/storage/" + images[i].image;
