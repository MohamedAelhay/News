                ...
                <div class="col-lg-12">
                    <div class="ibox float-e-margins">
                        ...
                        <div class="ibox-content">
                            ...
                            <form method="POST" enctype="multipart/form-data" class="form-horizontal" action={{route("upload.store", $folder)}}>
                                @csrf

                                <div class="row" style="padding: 20px">
                                    <div class="form-group col-sm-6 row"><label class="col-sm-4 control-label">Name</label>
                                        <input type="text" name="name" class="col-sm-8" value="{{ old('name') }}"placeholder="First Name" required="">
                                    ...
                                    <div class="form-group col-sm-6 row"><label class="col-sm-4 control-label">Last Name</label>
                                        <input type="text" name="description" class="col-sm-8" value="{{ old('description') }}"placeholder="Last Name" required="">
