        ...
        <div class="col-lg-12">
            <div class="ibox float-e-margins">
                ...
                <div class="ibox-content">
                    ...
                    <form method="POST" enctype="multipart/form-data" class="form-horizontal" action={{route("folders.update", $folder->id)}}>
                        @csrf
                        @method('PUT')

                        <div class="row" style="padding: 20px">
                            <div class="form-group col-sm-6 row"><label class="col-sm-4 control-label">Main Title</label>
                                <input type="text" name="name" class="col-sm-8" value="{{ $folder->name }}"placeholder="Folder Name" required="">
                            ...
                            <div class="form-group col-sm-6 row"><label class="col-sm-4 control-label">Second Title</label>
                                <input type="text" name="description" class="col-sm-8" value="{{ $folder->description }}"placeholder="Description" required="">
