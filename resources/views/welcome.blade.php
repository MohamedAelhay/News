...
@section('body')
    id="page-top" class="landing-page no-skin-config"
    @endsection
@section('styles')
    ...
    <section  class="container features">
        ...
        <div class="row">
            ...
            <div class="col-md-6 text-center  wow zoomIn">
                <img src={{asset("img/landing/perspective.png")}} alt="dashboard" class="img-responsive">
            </div>
            ...
            <div class="row">
                <div class="col-sm-4 wow fadeInLeft">
                    <div class="team-member">
                        <img src={{asset("img/landing/avatar3.jpg")}} class="img-responsive img-circle img-small" alt="">
                ...
                <div class="col-sm-4">
                    <div class="team-member wow zoomIn">
                        <img src={{asset("img/landing/avatar1.jpg")}} class="img-responsive img-circle" alt="">
                ...
                <div class="col-sm-4 wow fadeInRight">
                    <div class="team-member">
                        <img src={{asset("img/landing/avatar2.jpg")}} class="img-responsive img-circle img-small" alt="">
